...
{
	public hospital(handler passed_handler, float x, float y) 
	{
	...
	{
		g.drawImage(assets.hospital, (int) (x - myHandler.getGameCamera().getxOffset()), (int) (y - myHandler.getGameCamera().getyOffset()), width, height, null);
	}
