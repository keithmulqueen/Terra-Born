...
public class hole extends staticEntity 
{
	...
	public hole(handler passed_handler, float x, float y) 
	{
	...
	{
		g.drawImage(assets.hole, (int) (x - myHandler.getGameCamera().getxOffset()), (int) (y - myHandler.getGameCamera().getyOffset()), width, height, null);
	}
